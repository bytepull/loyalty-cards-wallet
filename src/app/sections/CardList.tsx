  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-6">
      {cards.map((card, index) => (
        <div
          key={index}
          className="flex w-full items-center justify-center h-20 p-3 dark:bg-gray-700 bg-white rounded-lg not-dark:border border-slate-200 shadow-md hover:shadow-lg transition-shadow"
